...
class RVAdapterPeminjaman (private val context: Context, private val arrayList: ArrayList<Buku>)
    : RecyclerView.Adapter<RVAdapterPeminjaman.Holder>()  {
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.cvBuku.setOnClickListener {
            val i = Intent(context, PeminjamanBuku::class.java)
