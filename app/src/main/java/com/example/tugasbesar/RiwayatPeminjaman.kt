...
class RiwayatPeminjaman : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnTentangKami.setOnClickListener {
            val i = Intent(this@RiwayatPeminjaman, TentangKami::class.java)
            startActivity(i)
        }
        btnLokasi.setOnClickListener {
            val i = Intent(this@RiwayatPeminjaman, Lokasi::class.java)
            startActivity(i)
        }
        btnBeranda.setOnClickListener {
            val i = Intent(this@RiwayatPeminjaman, HalamanUser::class.java)
            startActivity(i)
        }
